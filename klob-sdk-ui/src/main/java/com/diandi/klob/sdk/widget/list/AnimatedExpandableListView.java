...
package com.diandi.klob.sdk.widget.list;
...
public class AnimatedExpandableListView extends ExpandableListView {
    ...
    public void expand(int groupPos) {
        if (mExpandId == -1) {
            this.expandGroupWithAnimation(groupPos);
            mExpandId = groupPos;
        } else if (mExpandId == groupPos) {
            this.collapseGroupWithAnimation(groupPos);
            mExpandId = -1;
        } else {
            this.collapseGroupWithAnimation(mExpandId);
            this.expandGroupWithAnimation(groupPos);
            mExpandId = groupPos;
        }
    }
    ...
    public boolean expandGroupWithAnimation(int groupPos) {
        ...
        if (groupPos != adapter.getGroupCount() - 1) {
