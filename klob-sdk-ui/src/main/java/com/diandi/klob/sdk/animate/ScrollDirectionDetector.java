...
public abstract class ScrollDirectionDetector implements AbsListView.OnScrollListener {
    ...
    private ScrollDirectionListener mScrollDirectionListener2;
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
        mMinSignificantScroll = PixelUtil.dp2px(10);
    }
    ...
    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        ...
        if (mScrollDirectionListener2 != null && isSameRow(firstVisibleItem) && isSignificantDelta(newScrollY)) {
            if (isScrollUp(newScrollY)) {
                mScrollDirectionListener2.onScrollUp();
            } else {
                mScrollDirectionListener2.onScrollDown();
            }
        }
    ...
    public void setScrollDirectionListener2(ScrollDirectionListener mScrollDirectionListener) {
        this.mScrollDirectionListener2 = mScrollDirectionListener;
    }
